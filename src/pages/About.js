...
export default function AboutCheckworthyAI() {
  return (
    <section
      className="relative bg-gradient-to-b from-[#3D52A0] to-[#EDE8F5] py-24 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 min-h-screen overflow-hidden"
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-20">
        ...
        <div>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 text-white md:grid-cols-3 gap-3 mb-2 ">
